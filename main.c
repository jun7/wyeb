...
" color:#109; padding:0 .4em; border-radius:.2em; text-decoration:none;\n"
" display:inline-block; -webkit-transform:rotate(-.3deg);\n"
"}\n"
...
"###Specific Keys:\n"
"- **`e`** : Edits this page\n"
"- **`E`** : Edits main config file\n"
"- **`c`** : Opens config directory\n"
"- **`m`** : Shows this page\n"
"- **`M`** : Shows **[history]("APP":history)**\n"
"- **`b`** : Adds title and URI of a page opened to this page\n"
"\n"
"If **e,E,c** don't work, edit values '`"MIMEOPEN"`' of ~/.config/"DIRNAME"/main.conf.\n"
"\n"
"For other keys, see **[help]("APP":help)**assigned '**:**'.\n"
"Since "APP" is inspired by **[dwb](https://wiki.archlinux.org/index.php/dwb)**and\n"
"luakit, usage is similar to them.\n"
"\n---\n\n"
